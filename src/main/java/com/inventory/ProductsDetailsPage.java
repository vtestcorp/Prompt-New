...
public class ProductsDetailsPage extends Base {
	...
	@FindBy(xpath = "//input[@placeholder=\"Part No.\"]")
	...
	@FindBy(xpath = "(//*[text()='Select a attribute'])[6]")
	public WebElement attributeDrop2;

	@FindBy(xpath = "(//*[text()='Select a attribute'])[7]")
...
//////////////////// Import Product Validation ///////////////////////////
	...
	public void ImportProductValidation() throws Exception {
		...
		Thread.sleep(1000);
		driver.findElement(By.xpath("//li[@name='" + Utility.excelRead(2, 32, "InventoryDetails") + "']")).click();

		Utility.click(manufactureDropImport);
		Thread.sleep(1000);
		driver.findElement(By.xpath("//li[@name='" + Utility.excelRead(2, 33, "InventoryDetails") + "']")).click();

		Utility.click(brndDropImport);
		Thread.sleep(1000);
		driver.findElement(By.xpath("//li[@name='" + Utility.excelRead(2, 34, "InventoryDetails") + "']")).click();

		Utility.click(warhseDropImport);
		Thread.sleep(1000);
		driver.findElement(By.xpath("//li[@name='" + Utility.excelRead(2, 35, "InventoryDetails") + "']")).click();

		Utility.click(attributeDropImport);
		Thread.sleep(1000);
		driver.findElement(By.xpath("//li[@name='" + Utility.excelRead(2, 36, "InventoryDetails") + "']")).click();

		Utility.click(nextImport);

		Utility.click(uploadButtonImport);
...
//////////////////// Duplicate SKU Validation ///////////////////////////
	...
	public void DuplicateSKUValidation() throws Exception {
		...
		try {
			driver.findElement(By.xpath("//*[text()='Error Message']"));
			errortext = true;
