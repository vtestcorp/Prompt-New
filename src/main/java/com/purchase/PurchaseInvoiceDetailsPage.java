...
// Utility.click(ShippSelect);
		...
		driver.findElement(By.xpath("//div[@name='" + Utility.excelRead(7, 20, "SupplierDetails") + "']")).click();
...
//// common in all/////
		...
		expectedResult.add(projctDrop1.getText());
...
//// 1st product////////
		...
		expectedResult.add(SpclDscnt1.getText());
...
///// 2nd product////////
		...
		expectedResult.add(SpclDscnt2.getText());
		expectedResult.add(Hsn2.getText());
		expectedResult.add(amount2.getText());

//////////////////////////////////////////////////////////////
		System.out.println(supplierName.getText());
		System.out.println(projctDrop1.getText());
// expectedResult.add(placeofSupply.getText());
		System.out.println(Ref.getText());
		System.out.println(ShippDrop.getText());
		System.out.println(PayemntDrop.getText());

		System.out.println(subTotalExpectd.getText());
		System.out.println(discountExpectd.getText().replaceAll("[^0-9.]", ""));
		System.out.println(gst1Expectd.getText());
		System.out.println(gst2Expectd.getText());
		System.out.println(totalAmountExpectd.getText());
		System.out.println(internalRemarks.getText());
		System.out.println(supplierRemarks.getText());
//// expectedResult.add(footerText.getText());

//// 1st product////////
		System.out.println(Product1.getText());
		System.out.println(Quantity1.getText().replaceFirst("\\.0*$|(\\.\\d*?)0+$", "$1"));
		System.out.println(UOM1.getText());
		System.out.println(rate1.getText().split("\\.")[0]);
		System.out.println(SpclDscnt1.getText());
		System.out.println(Hsn1.getText());
		System.out.println(amount1.getText());
///// 2nd product////////
		System.out.println(Product2.getText());
		System.out.println(Quantity2.getText().replaceFirst("\\.0*$|(\\.\\d*?)0+$", "$1"));
		System.out.println(UOM2.getText());
		System.out.println(rate2.getText());
		System.out.println(SpclDscnt2.getText());
		System.out.println(Hsn2.getText());
		...
		System.out.println(supplierActual.getText());
		System.out.println(projectActual.getText().replace("Project - PRJ-1() ", ""));
// actualResult.add(placeofSupplyActual.getText());
		System.out.println(refActual.getText());
		System.out.println(shippingActual.getText());
		System.out.println(paymentActual.getText());

		System.out.println(subTotalActual.getText());
		System.out.println(discountActual.getText());
// System.out.println(gst1Actual.getText());
// System.out.println(gst2Actual.getText());
		System.out.println(grandTotalInvActual.getText());
		System.out.println(internalRemarkActual1.getText());
		System.out.println(suppRemarkActual.getText());
// actualResult.add(footerText.getText());

//// 1st product////////
		System.out.println(prodctActual1.getText());
// System.out.println(quantityActual1.getText().replaceFirst("\\.0*$|(\\.\\d*?)0+$",
// "$1"));
		System.out.println(uomInvActual1.getText());
		System.out.println(rateInvActual1.getText());
		System.out.println(spclDiscountInvActual1.getText());
		System.out.println(hsnInvActual1.getText());
		System.out.println(amountInvActual1.getText());
///// 2nd product////////
		System.out.println(prodctActual2.getText());
// System.out.println(quantityActual2.getText().replaceFirst("\\.0*$|(\\.\\d*?)0+$",
// "$1"));
		System.out.println(uomInvActual2.getText());
		System.out.println(rateInvActual2.getText());
		System.out.println(spclDiscountInvActual2.getText());
		System.out.println(hsnInvActual2.getText());
		System.out.println(amountInvActual2.getText());
...
// actualResult.add(gst2Actual.getText());
		actualResult.add(grandTotalInvActual.getText());
...
// actualResult.add(quantityActual1.getText().replaceFirst("\\.0*$|(\\.\\d*?)0+$",
// "$1"));
		actualResult.add(uomInvActual1.getText());
		actualResult.add(rateInvActual1.getText());
		actualResult.add(spclDiscountInvActual1.getText());
		actualResult.add(hsnInvActual1.getText());
		actualResult.add(amountInvActual1.getText());
///// 2nd product////////
		actualResult.add(prodctActual2.getText());
// actualResult.add(quantityActual2.getText()aceFir.replst("\\.0*$|(\\.\\d*?)0+$",
// "$1"));
		actualResult.add(uomInvActual2.getText());
		actualResult.add(rateInvActual2.getText());
		actualResult.add(spclDiscountInvActual2.getText());
